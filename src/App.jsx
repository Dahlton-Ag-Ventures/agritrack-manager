...
const [serviceForm, setServiceForm] = useState({
  ...
  const [showingReminders, setShowingReminders] = useState(false);
  ...
  <div>
    <div style={styles.tabHeader}>
      <div style={{ display: 'flex', alignItems: 'center', gap: '16px', flexWrap: 'wrap' }}>
        ...
        <button
          onClick={() => setShowingReminders(!showingReminders)}
          style={{
            padding: '10px 20px',
            background: showingReminders ? '#8b5cf6' : '#2563eb',
            border: 'none',
            borderRadius: '8px',
            color: 'white',
            cursor: 'pointer',
        ...
        >
          {showingReminders ? '🚜 View Machines' : '⏰ View Reminders'}
        </button>
      </div>
      {!showingReminders && userRole !== 'employee' && (
<button 
  onClick={() => {
