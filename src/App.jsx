        ...
        return (
          <div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '4px', padding: '6px 8px', background: toolbarBg, borderBottom: `0.5px solid ${cardBorder}`, flexWrap: 'nowrap', overflowX: 'auto' }}>
             <button style={{ ...btnStyle, fontWeight: 'bold', background: activeFormats.bold ? '#9FE1CB' : 'transparent', color: activeFormats.bold ? '#085041' : textSub }} onPointerDown={e => { e.preventDefault(); execCmd('bold'); }} onMouseDown={e => { e.preventDefault(); execCmd('bold'); }} title="Bold">B</button>
                <button style={{ ...btnStyle, fontStyle: 'italic', background: activeFormats.italic ? '#9FE1CB' : 'transparent', color: activeFormats.italic ? '#085041' : textSub }} onPointerDown={e => { e.preventDefault(); execCmd('italic'); }} onMouseDown={e => { e.preventDefault(); execCmd('italic'); }} title="Italic">I</button>
                <button style={{ ...btnStyle, textDecoration: 'underline', background: activeFormats.underline ? '#9FE1CB' : 'transparent', color: activeFormats.underline ? '#085041' : textSub }} onPointerDown={e => { e.preventDefault(); execCmd('underline'); }} onMouseDown={e => { e.preventDefault(); execCmd('underline'); }} title="Underline">U</button>
                <button style={{ ...btnStyle, textDecoration: 'line-through', background: activeFormats.strikeThrough ? '#9FE1CB' : 'transparent', color: activeFormats.strikeThrough ? '#085041' : textSub }} onPointerDown={e => { e.preventDefault(); execCmd('strikeThrough'); }} onMouseDown={e => { e.preventDefault(); execCmd('strikeThrough'); }} title="Strikethrough">S</button>
                {divider}
