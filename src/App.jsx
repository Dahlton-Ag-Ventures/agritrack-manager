...
const themes = {
  dark: {
    background: '#1e1b4b',
    backgroundImage: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #1e1b4b 100%), radial-gradient(circle at 30% 30%, rgba(139, 92, 246, 0.0005) 0%, transparent 50%), radial-gradient(circle at 70% 70%, rgba(167, 139, 250, 0.003) 0%, transparent 50%)',
