  ...
  <div style={styles.syncStatus}>
    <span style={{ color: '#d1d5db', fontSize: '0.9rem', fontWeight: '600' }}>
      {realtimeStatus === 'connected' 
        ...
        {activeTab === 'settings' && (
          <div>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '24px', color: theme === 'dark' ? '#ffffff' : '#111827' }}>Settings</h2>
            
            {/* Data Management Section */}
            <div style={{ 
              background: theme === 'dark' ? '#1e3a5f' : '#f3f4f6', 
              border: `1px solid ${theme === 'dark' ? '#2563eb' : '#d1d5db'}`,
              borderRadius: '12px',
              padding: '24px',
              marginBottom: '24px'
            }}>
              <h3 style={{ fontSize: '1.25rem', marginBottom: '16px', color: theme === 'dark' ? '#ffffff' : '#111827' }}>Data Management</h3>
              ...
              <div style={{ display: 'grid', gap: '12px' }}>
                ...
                <div style={{ 
                  margin: '16px 0', 
                  borderTop: `1px solid ${theme === 'dark' ? '#2563eb' : '#d1d5db'}`, 
                  paddingTop: '16px' 
                }}>
                  <label style={{ 
                    display: 'block', 
                  ...
                  <input 
                    ...
                    style={{ 
                      width: '100%',
                      padding: '12px',
                      background: theme === 'dark' ? '#1a2942' : '#ffffff',
                      border: `1px solid ${theme === 'dark' ? '#2563eb' : '#d1d5db'}`,
                      borderRadius: '8px',
            ...
            <div style={{ 
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '16px', color: theme === 'dark' ? '#ffffff' : '#111827' }}>Display Settings</h3>
              
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ color: theme === 'dark' ? '#d1d5db' : '#4b5563', fontWeight: '600' }}>Theme</span>
                <button 
                  onClick={() => setTheme(theme === 'dark' ? 'light' : 'dark')}
                  style={{ 
                    padding: '10px 20px',
                    background: theme === 'dark' ? '#2563eb' : '#10b981',
                    border: 'none',
                    borderRadius: '8px',
                    color: 'white',
                    cursor: 'pointer',
            ...
            <div style={{ 
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '16px', color: theme === 'dark' ? '#ffffff' : '#111827' }}>Account Settings</h3>
              
              <div style={{ marginBottom: '16px' }}>
                <p style={{ color: theme === 'dark' ? '#9ca3af' : '#6b7280', fontSize: '0.875rem', marginBottom: '4px' }}>Email</p>
                <p style={{ color: theme === 'dark' ? '#ffffff' : '#111827', fontSize: '1rem' }}>{user?.email}</p>
              </div>
            ...
            <div style={{ 
              ...
              <h3 style={{ fontSize: '1.25rem', marginBottom: '16px', color: theme === 'dark' ? '#ffffff' : '#111827' }}>App Information</h3>
